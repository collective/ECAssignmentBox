...
from Products.ECAssignmentBox.content.ListOfFilesField  import ListOfFilesField
...
ECAssignmentSchema = ECAssignmentSchema + Schema((
    ...
    ListOfFilesField(
        ...
        widget = ListOfFilesWidget(
            ...
            label = "Submission",
            description = 'The submission for this assignment containing all files',
            label_msgid = 'label_submission',
            description_msgid = 'help_submission',
...
class ECAssignment(BaseContent, HistoryAwareMixin):
    ...
    def get_data(self, instance):
        ...
        @return file content at dict-position index
        """
	result = None
	mt = instance.getContentType()
    ...
    #def getContentType(self, instance, index = 0):
	#"""Returns the content type from a field.
	#"""
	#value = 'text/plain'
	#
	#field = self.getSubmission()
	#file = field[index]
    ...
    def evaluate(self, parent, recheck=False):
        ...
        input values.
        For ECAssignment this method returns nothing but it can be 
    ...
    def getViewModeReadFieldNames(self):
        ...
        """
	return ['submission', 'remarks', 'feedback', 'mark']
