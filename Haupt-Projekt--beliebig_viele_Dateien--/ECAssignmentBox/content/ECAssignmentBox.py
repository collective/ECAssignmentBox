...
ECAssignmentBox_schema = ATFolderSchema.copy() + Schema((
    ...
    IntegerField(
        ...
        widget = IntegerWidget(
            ...
            label_msgid='label_numFiles',
            description="Number of files. First file is always main file, which will be checked in backend e.g.",
            description_msgid='help_numFiles',
            i18n_domain=config.I18N_DOMAIN,
            ),
        ),
